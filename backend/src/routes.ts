...
import os from 'os';
import { votingCreateController } from '@useCases/Votings/StartVotingProcess';
import { voteCreateController } from '@useCases/Votings/CreateVote';
...
import { getVotingDetailsController } from '@useCases/Votings/GetVotingDetails';
...
router.post('/condominium/:condominiumID/orders/:orderID/voting', verifyJWT, (req, res) => {
  votingCreateController.handle(req, res); // start voting process
});
